...
<head>
    ...
    <title>Lihat design Design</title>
    <link href="https://cdn.jsdelivr.net/npm/tailwindcss@2.2.16/dist/tailwind.min.css" rel="stylesheet">
</head>
<body class="bg-gray-100 flex justify-center items-center h-screen">
    <div class = 'card'>
    <div class="bg-white p-6 rounded-lg shadow-lg max-w-md w-full">
        <h1 class="text-3xl font-bold mb-4 text-center">Lihat design Design</h1>
       
        <div class="mb-4">
            <strong class="block text-gray-700 font-semibold">Nama:</strong>
            <p class="text-gray-900 border border-gray-300 p-2 rounded">{{ $design->nama }}</p>
        </div>
        <div class="mb-4">
            <strong class="block text-gray-700 font-semibold">Tanggal:</strong>
            <p class="text-gray-900 border border-gray-300 p-2 rounded">{{ $design->tanggal }}</p>
        </div>
        <div class="mb-4">
            <strong class="block text-gray-700 font-semibold">Ukuran:</strong>
            <p class="text-gray-900 border border-gray-300 p-2 rounded">{{ $design->ukuran }}</p>
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <p class="text-gray-900 border border-gray-300 p-2 rounded">{{ $design->text }}</p>
        </div>
